...
def start_with_shipping_callback(bot, update):
    print("start_with_shipping_callback")
    ...
    provider_token = "361519591:TEST:0a27779152d203bd2e35401198c82a78"
...
def start_without_shipping_callback(bot, update):
    print("start_without_shipping_callback")
...
def main():
    ...
    print("main")
    updater = Updater(token="546684347:AAE_TO7s9hraDKHm2Nz8PxEKeMyvJOzv8ow")
